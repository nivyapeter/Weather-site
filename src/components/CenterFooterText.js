...
function CenterFooterText() {
  return (
    <div>
      <div className="flex flex-wrap md:flex-nowrap flex-row md:justify-center justify-start mb-4 mx-8">
        <span className="px-2">Feedback</span>
        <span className="px-2">Weather API</span>
        <span className="px-2">Press Room</span>
      </div>
      <div className="flex flex-row md:justify-center justify-start flex-wrap md:flex-nowrap mb-4 mx-8">
        <span className=" border-r-2 px-2 font-bold">Tearms of Use</span>
        <span className=" border-r-2 px-2 font-bold">Privacy Policy</span>
        <span className=" border-r-2 px-2 font-bold">
          Accessibility Statement
        </span>
        <span className=" border-r-2 px-2 font-bold">Data Vendors</span>
      </div>
      <div className="flex flex-row md:justify-center justify-start flex-wrap md:flex-nowrap items-center px-2 mb-6 mx-8">
        <div>
          <svg
            class="Icon--icon--3wCKh Footer--georgiaIcon--2T2M6"
            set="footer"
            name="georgia"
            height="34"
            theme=""
        ...
        <div className="mt-2 px-2">
          <svg
            class="Icon--icon--3wCKh Footer--essentialIcon--1hN7e"
            set="footer"
            name="eSSENTIAL"
            height="23"
            theme=""
            data-testid="Icon"
            aria-hidden="false"
            aria-label="Link to eSSENTIAL Accessibility assistive technology"
            role="img"
            width="60"
            viewBox="0 0 60 23"
          >
      ...
      <div className="flex flex-row md:justify-center justify-start flex-wrap md:flex-nowrap mb-6 mx-8">
        <p className="text-sm">
          We recognise our responsibility to use data and technology for good.
          Take control of your data.
        </p>
      </div>
      <div className="flex flex-row md:justify-center justify-start flex-wrap md:flex-nowrap mx-8">
        <h1 className="font-bold">Data Rights</h1>
      </div>
